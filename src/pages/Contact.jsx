        ...
        <form>
          <div className="grid grid-cols-2 gap-4  ">
            ...
            <div>
              ...
              <input className="border border-gray-600 outline-none w-full p-2 md:py-5 rounded" placeholder="Enter Email" type="text" id={emailid} />
            </div>
            <div className="col-span-2 md:mt-8">
              <label className="block mb-2" htmlFor={messageid}>
                MESSAGE
              </label>
              <textarea className="border border-gray-600 outline-none   w-full p-2 md:py-10" placeholder="Write your message here..." id={messageid} rows="4" />
            </div>
          </div>
          <button className="border border-gray-600 px-4 py-2 rounded mt-2 md:py-3 md:px-10 text-2xl">Send</button>
        </form>
      </div>
    </div>
  );
